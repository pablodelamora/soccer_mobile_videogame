...
public class CenterPlayer2Script : MonoBehaviour
{
   ...
   // [SerializeField] private GameObject pausePanel;
    ...
    void Start()
    {
        ...
        JCentro1 = GameObject.FindGameObjectWithTag("JCentro1").transform; // Este se va en el original
        randomNumber = true;
    ...
    void Update()
    {
        ...
        if (primeraEsLibre)
        {
            if (Vector3.Distance(transform.position, Ball.position) < Vector3.Distance(JCentro1.position, Ball.position))
            {
